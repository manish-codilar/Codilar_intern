...
namespace Codilaar\Marketplace\Test\Integration;
...
class ModuleConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->subjectModuleName = 'Codilaar_Marketplace';
    ...
    public function testTheModuleIsRegistered()
    {
        ...
        $this->assertArrayHasKey('Codilaar_Marketplace', $registrar->getPaths(ComponentRegistrar::MODULE));
    }
